...
def run_all_ai_tests():
    ...
    print("[TEST GROUP 1/3] AI Environment Configuration")
    print("-" * 70)
    try:
    ...
    # Test 2: AI Client
    print("[TEST GROUP 2/3] AI Client Interface")
    print("-" * 70)
    try:
    ...
    # Test 3: RAG System
    print("[TEST GROUP 3/3] RAG System (Retrieval-Augmented Generation)")
    print("-" * 70)
    try:
