/* DDCCS menu structure — captured from src/cli/* */
/* AI flag (ai) marks AI-powered actions; slow flag marks long-running ops */
...
const MENU_DATA = {
  ...
  modelProfiles: [
    { id: 'claude-sonnet', name: 'Claude Sonnet 4.5', task: 'story_generation', active: true },
  ...
  utilityCommands: [
    ...
    { cmd: '--sync-drupal', label: 'Sync to Drupal', ai: false },
  ],
  characters: [
