...
const NPCsPage: React.FC<PageProps<RosterData>> = ({ data, location }) => (
  <BaseTemplate currentPath={location.pathname}>
    <CharacterRoster data={data} isNpc={true} />
  </BaseTemplate>
);
...
export const Head: HeadFC = () => <title>NPCs | D&amp;D Consultant</title>;
